...
pub use crate::algorithm::{
    ...
    convert, convex_hull, coordinate_position, correct, correct_closure, covered_by, densify,
    destination, destination_with, discrete_frechet_distance, discrete_frechet_distance_with,
    ...
    for_each_point, for_each_segment, intersects, intersects_reversed, is_convex, is_empty,
    is_simple, length, length_dyn, length_with, line_interpolate, line_locate_point,
    linestring_segmentize, linestring_segmentize_with, make_box, make_point, make_segment,
    map_coords, map_coords_in_place, multi_polygon_area, num_geometries, num_interior_rings,
    num_points, num_segments, perimeter, perimeter_with, remove_spikes, reverse, ring_area,
    ring_perimeter, ring_perimeter_with, simplify, simplify_with, transform, unique, within,
    within_dyn,
};
